...
__Local deformations__ are calculated using a sliding window approach which quantifies local deviations after optimal superposition. A window around unit $i$ is defined and then aligned to the reference structure using the Kabsch algorithm [@kabsch1976solution] as:
